    ...
    class Call
    {
        public:
            ...
            inline void setValue(shared_ptr<Writable> v) {
                ...
                Log::write(DEBUG, "after set value, _strVal:%s, _value : %s\n",
                           _valueBuf, _value->printToString().c_str());
            }

            inline const unsigned char* getValueBuf() const {return _valueBuf;}
